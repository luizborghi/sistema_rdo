...
if ($_SESSION['usuario_tipo'] == 'fiscal') {
    $sql .= " AND EXISTS (SELECT 1 FROM obras WHERE id = r.obra_id AND fiscal_id = ?)";
...
if ($_SESSION['usuario_tipo'] == 'fiscal') {
    $stmt = $db->prepare("SELECT id, codigo, nome FROM obras WHERE fiscal_id = ? ORDER BY nome");
    ...
    <div class="container-fluid mt-4">
        ...
        <?php if ($_SESSION['usuario_tipo'] == 'fiscal'): ?>
            <div class="alert alert-info">
                ...
                <strong>Modo Fiscal:</strong> Você está visualizando apenas os RDOs das obras onde você é o fiscal responsável.
            </div>
        <?php endif; ?>
